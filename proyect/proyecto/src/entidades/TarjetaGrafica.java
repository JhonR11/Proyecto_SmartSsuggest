...
public class TarjetaGrafica {
   ...
   private String gama;
    ...
    public TarjetaGrafica(String nombre, String modelo, String vram, String tipomemoria, int consumo, boolean alimentacion_externa, String pines, String puerto, int procesadores, String gama) {
        nid++;
        this.id=nid;
        this.nombre = nombre;
        this.modelo = modelo;
    ...
    public String toString() {
        return """
               id\tnombre\tmodelo\tvram\ttipo de memoria\tWatts\tNumero de pines\tTipo de puerto\tnumero de proecesadores\tgama
               """+
              id+"\t"+nombre + "\t"+modelo +"\t" + vram +"\t"+tipomemoria + "\t\t" +consumo + "\t"+pines + "\t\t" +puerto + "\t"+procesadores + "\t\t"+gama +"\n";
